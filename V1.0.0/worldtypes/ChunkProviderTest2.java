package net.minecraft.src.worldtypes;
...
public class ChunkProviderTest2 implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderTest2(World par1World, long par2, boolean par4)
    {
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        this.sandNoise = this.beachNoise.generateNoiseOctaves(this.sandNoise, (double)(par1 * 16), (double)(par2 * 16), 0.0D, 16, 16, 1, var6, var6, 1.0D);
        this.gravelNoise = this.beachNoise.generateNoiseOctaves(this.gravelNoise, (double)(par1 * 16), 109.0134D, (double)(par2 * 16), 16, 1, 16, var6, 1.0D, var6);
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var18 = 127; var18 >= 0; --var18)
                {
                    ...
                    {
                        par3ArrayOfByte[var19] = (byte)Block.bedrock.blockID;
                    }
                    else
                    {
                        byte var20 = par3ArrayOfByte[var19];
                        ...
                        else if (var20 == Block.stone.blockID)
                        {
                            if (var15 == -1)
                            {
                                ...
                                else if (var18 >= var5 - 4 && var18 <= var5 + 1)
                                {
                                    var16 = var10.topBlock;
                                    var17 = var10.fillerBlock;

                                    if (var10.enablebeach)
                                    {
                                        if (var13)
                                        {
                                            var16 = 0;
                                ...
                                if (var18 >= var5 - 1)
                                {
                                    par3ArrayOfByte[var19] = var16;
                                }
                                else
                                {
                                    par3ArrayOfByte[var19] = var17;
                                }
                            }
                            else if (var15 > 0)
                            {
