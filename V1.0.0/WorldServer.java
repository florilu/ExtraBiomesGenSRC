...
public class WorldServer extends World
{
    ...
    public void scheduleBlockUpdate(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        else if (this.checkChunksExist(par1 - var7, par2 - var7, par3 - var7, par1 + var7, par2 + var7, par3 + var7))
        {
            if (par4 > 0)
            {
    ...
    protected void createSpawnPosition(WorldSettings par1WorldSettings)
    {
        ...
        else
        {
            ...
            int var8 = 0;
            int var9 = this.provider.getSpawnType();
            ...
            if (var9 == 2)
            {
                this.worldInfo.setSpawnPosition(0, var7, 0);
            }
            else
            {
                while (!this.provider.canCoordinateBeSpawn(var6, var8, var9))
                {
    ...
    public void setTime(long par1)
    {
        ...
        for (Iterator var6 = this.field_73064_N.iterator(); var6.hasNext(); var5.scheduledTime += var3)
        {
            var5 = (NextTickListEntry)var6.next();
        }

        Block[] var10 = Block.blocksList;
        int var7 = var10.length;

        for (int var8 = 0; var8 < var7; ++var8)
        {
            Block var9 = var10[var8];

            if (var9 != null)
            {
                var9.onTimeChanged(this, var3, par1);
            }
        }
