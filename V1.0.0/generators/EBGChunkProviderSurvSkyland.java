...
public class EBGChunkProviderSurvSkyland implements IChunkProvider
{
    ...
    public EBGNoiseGeneratorOctaves noiseGen4;
    ...
    public EBGChunkProviderSurvSkyland(World var1, long var2)
    {
        this.endWorld = var1;
        this.endRNG = new Random(var2);
        this.noiseGen1 = new EBGNoiseGeneratorOctaves(this.endRNG, 16);
        this.noiseGen2 = new EBGNoiseGeneratorOctaves(this.endRNG, 16);
        this.noiseGen3 = new EBGNoiseGeneratorOctaves(this.endRNG, 8);
        this.noiseGen4 = new EBGNoiseGeneratorOctaves(this.endRNG, 10);
        this.noiseGen5 = new EBGNoiseGeneratorOctaves(this.endRNG, 16);
    }
    ...
    private double[] func_40379_a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7)
    {
        ...
        this.noiseData5 = this.noiseGen5.generateNoiseOctaves(this.noiseData5, var2, var4, var5, var7, 400.0D, 400.0D, 0.5D);
        var8 *= 2.0D;
        this.noiseData1 = this.noiseGen3.generateNoiseOctaves(this.noiseData1, (double)var2, (double)var3, (double)var4, var5, var6, var7, var8 / 80.0D, var10 / 160.0D, var8 / 80.0D);
        this.noiseData2 = this.noiseGen1.generateNoiseOctaves(this.noiseData2, (double)var2, (double)var3, (double)var4, var5, var6, var7, var8, var10, var8);
        this.noiseData3 = this.noiseGen2.generateNoiseOctaves(this.noiseData3, (double)var2, (double)var3, (double)var4, var5, var6, var7, var8, var10, var8);
        int var12 = 0;
        int var13 = 0;
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        if (this.endRNG.nextInt(1) == 0)
        {
            ...
            (new WorldGenLakes(Block.waterStill.blockID)).generate(this.endWorld, this.endRNG, var7, var8, var9);
        }

        if (this.endRNG.nextInt(6) == 0)
        {
            var7 = var4 + this.endRNG.nextInt(16) + 8;
            var8 = this.endRNG.nextInt(this.endRNG.nextInt(120) + 8);
            var9 = var5 + this.endRNG.nextInt(16) + 8;

            if (var8 < 63 || this.endRNG.nextInt(10) == 0)
            {
                (new WorldGenLakes(Block.lavaStill.blockID)).generate(this.endWorld, this.endRNG, var7, var8, var9);
            }
        }

        if (var2 == 0 && var3 == 0)
        {
            var7 = -25 + this.endRNG.nextInt(50);
            var8 = -25 + this.endRNG.nextInt(50);

            if (!(new EBGGenDungeons2(5)).generate(this.endWorld, this.endRNG, var7, 55, var8))
            {
                ;
            }
            ...
            if (!(new EBGGenDungeons2(6)).generate(this.endWorld, this.endRNG, var7, 45, var8))
            {
                ;
            }
            ...
            if (!(new EBGGenDungeons2(7)).generate(this.endWorld, this.endRNG, var7, 35, var8))
            {
                ;
            }
        }
        ...
        for (var7 = 0; var7 < 12; ++var7)
        {
            ...
            int var10 = var5 + this.endRNG.nextInt(16) + 8;
