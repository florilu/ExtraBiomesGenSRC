...
public class EBGVillageFarm3 extends ComponentVillage
{
    private int averageGroundLevel = -1;

    public EBGVillageFarm3(ComponentVillageStartPiece var1, int var2, Random var3, StructureBoundingBox var4, int var5)
    {
        super(var1, var2);
    ...
    public static EBGVillageFarm3 findValidPlacement(ComponentVillageStartPiece var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(var3, var4, var5, 0, 0, 0, 13, 4, 9, var6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(var1, var8) == null ? new EBGVillageFarm3(var0, var7, var2, var8, var6) : null;
    }
