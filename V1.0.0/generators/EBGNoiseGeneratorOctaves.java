...
public class EBGNoiseGeneratorOctaves extends NoiseGenerator
{
    private EBGNoiseGeneratorPerlin[] generatorCollection;
    private int octaves;

    public EBGNoiseGeneratorOctaves(Random var1, int var2)
    {
        this.octaves = var2;
        this.generatorCollection = new EBGNoiseGeneratorPerlin[var2];

        for (int var3 = 0; var3 < var2; ++var3)
        {
            this.generatorCollection[var3] = new EBGNoiseGeneratorPerlin(var1);
        }
    }
