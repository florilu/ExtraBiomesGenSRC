...
public class EBGChunkProviderBeta implements IChunkProvider
{
    private Random rand;
    ...
    public EBGChunkProviderBeta(World var1, long var2, boolean var4)
    {
        this.worldObj = var1;
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        for (var13 = 0; var13 < 20; ++var13)
        {
            ...
            var15 = this.rand.nextInt(128);
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.dirt.blockID, 32)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 10; ++var13)
        {
            ...
            var15 = this.rand.nextInt(128);
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.gravel.blockID, 32)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 20; ++var13)
        {
            ...
            var15 = this.rand.nextInt(128);
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreCoal.blockID, 16)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 20; ++var13)
        {
            ...
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreIron.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 2; ++var13)
        {
            ...
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreGold.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 8; ++var13)
        {
            ...
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreRedstone.blockID, 7)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 1; ++var13)
        {
            ...
            var15 = this.rand.nextInt(16);
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreDiamond.blockID, 7)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 1; ++var13)
        {
            ...
            var16 = var5 + this.rand.nextInt(16);
            (new EBGGenMinable(Block.oreLapis.blockID, 6)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var17 = 0; var17 < 10; ++var17)
        {
            ...
            var19 = this.rand.nextInt(128);
            var20 = var5 + this.rand.nextInt(16) + 8;
            (new EBGGenReed()).generate(this.worldObj, this.rand, var26, var19, var20);
        }
