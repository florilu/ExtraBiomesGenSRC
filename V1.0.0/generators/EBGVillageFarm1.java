...
public class EBGVillageFarm1 extends ComponentVillage
{
    private int averageGroundLevel = -1;

    public EBGVillageFarm1(ComponentVillageStartPiece var1, int var2, Random var3, StructureBoundingBox var4, int var5)
    {
        super(var1, var2);
    ...
    public static EBGVillageFarm1 findValidPlacement(ComponentVillageStartPiece var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(var3, var4, var5, 0, 0, 0, 13, 4, 9, var6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(var1, var8) == null ? new EBGVillageFarm1(var0, var7, var2, var8, var6) : null;
    }
    ...
    public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3)
    {
        ...
        {
            this.placeBlockAtCurrentPosition(var1, Block.melonStem.blockID, 7, 2, 1, var4, var3);
            this.placeBlockAtCurrentPosition(var1, Block.melonStem.blockID, 7, 4, 1, var4, var3);
            this.placeBlockAtCurrentPosition(var1, Block.melonStem.blockID, 7, 8, 1, var4, var3);
            this.placeBlockAtCurrentPosition(var1, Block.melonStem.blockID, 7, 8, 1, var4, var3);
            this.placeBlockAtCurrentPosition(var1, Block.melonStem.blockID, 7, 10, 1, var4, var3);
        }
