...
public class EBGNoiseGeneratorOctaves2 extends NoiseGenerator
{
    private EBGNoiseGenerator2[] field_4234_a;
    private int field_4233_b;

    public EBGNoiseGeneratorOctaves2(Random var1, int var2)
    {
        this.field_4233_b = var2;
        this.field_4234_a = new EBGNoiseGenerator2[var2];

        for (int var3 = 0; var3 < var2; ++var3)
        {
            this.field_4234_a[var3] = new EBGNoiseGenerator2(var1);
        }
    }
