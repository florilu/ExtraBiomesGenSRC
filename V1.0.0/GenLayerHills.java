        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
                ...
                if (this.nextInt(3) == 0)
                {
                    ...
                    {
                        var10 = mod_EBGMain.oasis.biomeID;
                    }
                    ...
                    else if (var9 == mod_EBGMain.glacier.biomeID)
                    {
                    	var10 = mod_EBGMain.glacierhills.biomeID;
                    }
                    else if (var9 == mod_EBGMain.sandyHills.biomeID)
                    {
                    	var10 = mod_EBGMain.oasis.biomeID;
                    }
                    else if (var9 == mod_EBGMain.firelands.biomeID)
                    {
                    	var10 = mod_EBGMain.volcano.biomeID;
                    }
                    else if (var9 == mod_EBGMain.newdesert.biomeID)
                    {
                    	var10 = mod_EBGMain.oasis.biomeID;
                    }
                    else if (var9 == mod_EBGMain.mountains.biomeID)
                    {
                    	var10 = mod_EBGMain.coveredmountains.biomeID;
                    }
                    else if (var9 == mod_EBGMain.newforest.biomeID)
                    {
                    	var10 = mod_EBGMain.foresthills.biomeID;
                    }
                    else if (var9 == mod_EBGMain.redwoods.biomeID)
                    {
                    	var10 = mod_EBGMain.redwoodhills.biomeID;
                    }
                    else if (var9 == mod_EBGMain.littlemountainsgreen.biomeID)
                    {
                    	var10 = mod_EBGMain.littlemountains.biomeID;
                    }
                    if (var10 == var9)
                    {
